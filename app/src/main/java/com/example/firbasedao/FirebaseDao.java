...
public abstract class FirebaseDao<T> {
    public static final DatabaseReference dbReference = FirebaseDatabase.getInstance("https://salting-1635517386719-default-rtdb.europe-west1.firebasedatabase.app").getReference();
